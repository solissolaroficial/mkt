...
func main() {
	...
	if *seed {
		...
		if err := seeders.SeedAll(ctx, container.UserSeeder, container.KpiSeeder, container.SocialBenchmarkingSeeder, container.CooperativeSeeder, container.GiftSeeder); err != nil {
