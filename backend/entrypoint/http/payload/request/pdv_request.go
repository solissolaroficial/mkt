...
type UpdatePdvPostRequest struct {
	...
	PdvName            *string `json:"pdv_name,omitempty" validate:"omitempty,max=200"`
	PostDate           *string `json:"post_date,omitempty" validate:"omitempty,datetime=2006-01-02"`
	Platform           *string `json:"platform,omitempty" validate:"omitempty,oneof=instagram facebook linkedin youtube tiktok"`
	Link               *string `json:"link,omitempty" validate:"omitempty,url,max=500"`
	ProofUrl           *string `json:"proof_url,omitempty" validate:"omitempty,url,max=500"`
}
