...
type SocialDailyAggregationModel struct {
	...
	BrandID         uuid.UUID   `gorm:"type:uuid;not null;uniqueIndex:idx_brand_date,priority:1;index:idx_brand;constraint:fk_social_daily_aggregations_brand,foreignKey:BrandID,references:UUID,onDelete:RESTRICT,onUpdate:CASCADE"`
