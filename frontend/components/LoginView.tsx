      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-center mb-8">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h1 className="font-bold text-3xl tracking-tight text-white">Solis <span className="text-emerald-500">Hub</span></h1>
                </div>
            </div>
        </div>
        ...
        <div className="bg-[#1a1d24] border border-gray-800 rounded-2xl shadow-2xl p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <h2 className="text-2xl font-bold text-gray-100 mb-2 text-center">Bem-vindo de volta</h2>
          <p className="text-gray-500 text-center mb-8 text-sm">Insira suas credenciais para acessar o painel.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 cursor-pointer group">
                    <input type="checkbox" className="w-4 h-4 rounded bg-[#0f1115] border-gray-700 text-[#1e5144] focus:ring-offset-0 focus:ring-[#1e5144]" />
                    <span className="text-gray-500 group-hover:text-gray-400 transition-colors">Lembrar-me</span>
                </label>
                <a href="#" className="text-[#1e5144] hover:text-emerald-400 font-medium transition-colors">Esqueceu a senha?</a>
            </div>

            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#1e5144] hover:bg-[#163c32] text-white font-semibold py-3 rounded-xl transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center gap-2 shadow-lg shadow-[#1e5144]/20 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoading ? (
