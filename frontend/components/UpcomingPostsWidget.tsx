...
import { Calendar, Clock, Instagram, Youtube, Facebook, Linkedin, Star, Scissors, User, Users, Megaphone, AlertCircle } from 'lucide-react';
...
const UpcomingPostsWidget: React.FC<UpcomingPostsWidgetProps> = ({ posts, onViewCalendar }) => {
  ...
  // Filtrar posts:
  // 1. Data entre hoje e hoje + 7 dias
  // 2. Status não publicado (pending, approved, adjust, review, in_progress)
  ...
  const getPlatformIcon = (platforms?: string[]) => {
      ...
      // Retorna o ícone da primeira plataforma encontrada para exibição resumida
